...
ContinuumEngine2D::DebugRenderer::DebugRenderer() {
	// Empty
}
...
void ContinuumEngine2D::DebugRenderer::init() {
...
void ContinuumEngine2D::DebugRenderer::end() {
	glBindBuffer(GL_ARRAY_BUFFER, m_vbo);
	// Orphan the buffer
...
void ContinuumEngine2D::DebugRenderer::drawLine(const glm::vec2& a, const glm::vec2& b, const ColorRGB8& color) {
	int i = m_verts.size();
...
void ContinuumEngine2D::DebugRenderer::drawBox(const glm::vec4& destRect, const ColorRGB8& color, float angle) {
...
void ContinuumEngine2D::DebugRenderer::drawCircle(const glm::vec2& center, const ColorRGB8& color, float radius) {
...
void ContinuumEngine2D::DebugRenderer::render(const glm::mat4& projectionMatrix, float lineWidth) {
	m_program.use();
...
void ContinuumEngine2D::DebugRenderer::dispose() {
	if (m_vao) {
